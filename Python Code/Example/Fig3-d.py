...
utils.add_arc_from_to(t3, p2, net)
utils.add_arc_from_to(t3, p3, net)
utils.add_arc_from_to(p2, t_a, net)
utils.add_arc_from_to(p3, t_b, net)
utils.add_arc_from_to(t_a, p4, net)
utils.add_arc_from_to(t_b, p5, net)
utils.add_arc_from_to(p4, t4, net)
utils.add_arc_from_to(p5, t4, net)
utils.add_arc_from_to(t4, p6, net)
